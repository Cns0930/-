...
public interface Extractor {
     ...
     * @param checkpointConfigs 事项配置-提取点
     * @param mappingConfig 事项配置-提取策略映射
     * @return 结构化数据列表
     */
    List<DocumentKV> extract(List<Image> sortedImages, List<OcrOutput> ocrOutputs, List<CheckpointConfig> checkpointConfigs, Map<String, String> mappingConfig);
}
